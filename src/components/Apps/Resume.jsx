    ...
    return (
        <div className="h-full flex flex-col p-4">
            <div className="flex justify-between items-center mb-4 bg-gray-100 dark:bg-[#2d2d2d] p-3 rounded-lg">
                ...
                <a href="/resume.pdf" download="resss(5).pdf" className="flex items-center gap-2 bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-600 transition-colors text-sm font-medium">
